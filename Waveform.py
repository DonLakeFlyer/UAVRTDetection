...
#     end
    ...
    def __init__ (obj, x: np.ndarray, Fs: float, t_0: float, ps_pre: PulseStats, OLF: float, thresh: Threshold):
        ...
        obj.K       = None              # Unknown number of pulses.
        ...
        obj.ps_pos  = ps_pre.deepcopy() # Current stats are same as previous during construction
...
#             windows_in_cleaved_wfm = floor((samples_in_cleaved_wfm-n_ol)/n_ws);
        ...
        ind_start  = matlabFind(t <= t0, 1, 'last');
        ...
        if inds4cleavedwfm[-1] >= L: # samples_in_cleaved_wfm>=L# If we are at the end of the waveform
            ...
            if obj.stft.S is not None:
                ...
                wind_start          = matlabFind(obj.stft.t <= t0_wind, 1, 'last');
...
#          end
    ...
    def setPrioriDependatProps(obj, ps_obj):
